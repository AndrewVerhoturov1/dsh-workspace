...
export declare const AGENT_TEAM_RPC_CHANNEL = "/agent-team-gui";
/** Browser/host contract revision. A snapshot handshake prevents mixed-version UIs. */
export declare const AGENT_TEAM_RPC_API_VERSION = 4;
/** 创建逐 endpoint 校验的 RPC handler；所有失败使用 dsh 已有闭合 RpcError。 */
export declare function createAgentTeamRpcHandler(ctx: Context, service: AgentTeamService): ConnectionRpcHandler;
/** Connection 是 Web 可选服务；headless 仍可加载 host service 与模型工具。 */
export declare function registerAgentTeamRpc(ctx: Context, service: AgentTeamService): void;
