...
- Незакоммиченная доработка моста: строгий Fresh-proof для `SubmitOnly`; перед отправкой требуются действие `Новый чат` и три стабильных семантических UIA-снимка. Runtime ID не является доказательством нового чата.
