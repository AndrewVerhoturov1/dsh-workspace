...
protocol_version: 1
request_id: REQ_20260924T220841Z_6199
result_mode: text
repository: AndrewVerhoturov1/dsh-workspace
base_commit: ba9d2ad0a70c2ca14fca55a963c4d82de747f010

## User intent

Проведи содержательный технический обзор надёжности WebSocket: reconnect, heartbeat, ordering, backpressure, duplicate handling и восстановление после временного разрыва. Потрать достаточно времени на анализ, чтобы задача не завершилась мгновенно. Верни 5 структурированных пунктов и закончи точным маркером:
...
<<<POSTMAN_ASK_BEGIN:REQ_20260924T220841Z_6199>>>
<итоговый непустой текст>
<<<POSTMAN_ASK_END:REQ_20260924T220841Z_6199>>>
