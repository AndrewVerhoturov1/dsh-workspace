...
protocol_version: 1
request_id: REQ_20260924T120955Z_9821
result_mode: text
repository: AndrewVerhoturov1/dsh-workspace
base_commit: 9f407febfb2ffd2db2b3330904b4cd7628a61007

## User intent

Дай содержательный краткий технический обзор локальных очередей фоновых задач: admission, ограничение одновременного исполнения, отмена, повторные попытки, идемпотентность и корректное завершение процесса. Ответ примерно на минуту чтения, закончи точным маркером BRIDGE_C_73564.
...
<<<POSTMAN_ASK_BEGIN:REQ_20260924T120955Z_9821>>>
<итоговый непустой текст>
<<<POSTMAN_ASK_END:REQ_20260924T120955Z_9821>>>
