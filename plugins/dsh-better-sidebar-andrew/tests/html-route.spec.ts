...
describe('decodeHtmlUrl', () => {
  it('round-trips a workspace-qualified HTML route', () => {
    const url = encodeHtmlUrl('sess-1', 'C:\\worktrees\\postman\\docs\\index.html', 'C:\\worktrees\\postman')
    expect(decodeHtmlUrl(url)).toEqual({
      ok: true,
      ref: { sessionId: 'sess-1', path: 'C:/worktrees/postman/docs/index.html', workspaceRoot: 'C:\\worktrees\\postman' },
    })
  })
