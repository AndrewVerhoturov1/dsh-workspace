...
describe('version and feature detection (v0.12.0)', () => {
  it('keeps the public consumer API version independent from the Andrew package suffix', () => {
    ...
    expect(SIDEBAR_SERVICE_VERSION).toBe('0.15.2')
    expect(pkg.version).toBe('0.15.2-andrew.1')
