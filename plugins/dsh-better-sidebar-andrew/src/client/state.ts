...
export interface SidebarState {
  ...
  nextBrowser: number
  /** Selected linked worktree for built-in Files/Git surfaces; absent = session cwd/main. */
...
export function sanitizeState(parsed: unknown): SidebarState | undefined {
  ...
  if (record.workspaceRoot !== undefined && typeof record.workspaceRoot !== 'string') return undefined
