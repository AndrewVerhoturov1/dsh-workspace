window.__ModuleLoader__.load({
	id: "dsh-agent-teams-nanmicoder-by-andrew",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\andre\.dsh-worktrees\nanmicoder-by-andrew-foundation\plugins\dsh-agent-teams-nanmicoder-by-andrew\src\client\AgentTeamsCard.module.css.mjs
		const css$1 = ".cBrrcG_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}.cBrrcG_head{align-items:center;gap:8px;min-width:0;display:flex}.cBrrcG_leadAvatar{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0;flex:none;width:30px;height:30px}.cBrrcG_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.cBrrcG_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}.cBrrcG_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}.cBrrcG_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.cBrrcG_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cBrrcG_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}.cBrrcG_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}.cBrrcG_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}.cBrrcG_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cBrrcG_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d482e);background:0 0;border:0;border-radius:0;width:24px;height:24px}.cBrrcG_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}.cBrrcG_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		const tagId$1 = "dsh-agent-teams-nanmicoder-by-andrew/AgentTeamsCard.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$1) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-agent-teams-nanmicoder-by-andrew";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "cBrrcG_head",
			"leadAvatar": "cBrrcG_leadAvatar",
			"member": "cBrrcG_member",
			"memberArt": "cBrrcG_memberArt",
			"memberCount": "cBrrcG_memberCount",
			"memberInitial": "cBrrcG_memberInitial",
			"memberName": "cBrrcG_memberName",
			"members": "cBrrcG_members",
			"panelButton": "cBrrcG_panelButton",
			"root": "cBrrcG_root",
			"teamName": "cBrrcG_teamName"
		};
		//#endregion
		...
		* (historical session review). */
		...
		//#endregion
		//#region \0dsh-css:C:\Users\andre\.dsh-worktrees\nanmicoder-by-andrew-foundation\plugins\dsh-agent-teams-nanmicoder-by-andrew\src\client\ActivityPanel.module.css.mjs
		const css = "html{--agent-teams-panel-shift:420px}html[data-agent-teams-panel-open] [data-phase=active]{box-sizing:border-box;padding-right:var(--agent-teams-panel-shift)}._7N6W4G_badge,._7N6W4G_panel{--dsw-alias-line-normal:var(--dsw-static-neutral-bluish-150,#e7e9ee);--dsw-alias-line-strong:color-mix(in srgb, var(--dsw-static-neutral-bluish-200,#e1e5ee) 50%, var(--dsw-static-neutral-bluish-300,#cfd3d6));--dsw-alias-bg-module:var(--dsw-alias-bg-layer-1,#fff);--dsw-alias-bg-fill-neutral:var(--dsw-static-neutral-bluish-100,#eef0f4);--dsw-alias-bg-fill-business:var(--dsw-alias-state-business-primary,#4d6bfe);--dsw-alias-bg-fill-success:var(--dsw-alias-state-success-primary,#12a150);--dsw-alias-bg-fill-warning:var(--dsw-alias-state-warn-primary,#e08700);--dsw-alias-bg-fill-danger:var(--dsw-alias-state-error-primary,#e5484d);--dsw-alias-state-success:var(--dsw-alias-state-success-primary,#12a150);--dsw-alias-state-warning:var(--dsw-alias-state-warn-primary,#e08700);--dsw-alias-state-danger:var(--dsw-alias-state-error-primary,#e5484d);--dsw-alias-label-on-fill:var(--dsw-alias-label-primary-inverted,#fff)}._7N6W4G_badge{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:0 8px 28px color-mix(in srgb, var(--dsw-alias-label-primary) 14%, transparent);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .15s,transform .12s;display:inline-flex;position:absolute;top:64px;right:18px}._7N6W4G_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}._7N6W4G_badge:active{transform:translateY(0)scale(.98)}._7N6W4G_badge:focus-visible,._7N6W4G_iconButton:focus-visible,._7N6W4G_memberRow:focus-visible,._7N6W4G_membersToggle:focus-visible,._7N6W4G_sectionToggleTitle:focus-visible,._7N6W4G_dagNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._7N6W4G_badgeDot,._7N6W4G_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}._7N6W4G_badgeDot[data-busy=true],._7N6W4G_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite _7N6W4G_agentTeamsPulse}._7N6W4G_badgeCount,._7N6W4G_memberCount,._7N6W4G_teamStats,._7N6W4G_stageLabel,._7N6W4G_taskId{font-variant-numeric:tabular-nums}._7N6W4G_panel{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);box-shadow:0 12px 32px color-mix(in srgb, var(--dsw-alias-label-primary) 12%, transparent), 0 32px 72px color-mix(in srgb, var(--dsw-alias-label-primary) 16%, transparent);will-change:transform;border-radius:16px;flex-direction:column;animation:.16s ease-out _7N6W4G_agentTeamsPanelIn;display:flex;position:absolute;top:0;left:0;overflow:hidden}._7N6W4G_panel[data-dragging],._7N6W4G_panel[data-resizing]{user-select:none;box-shadow:0 16px 38px color-mix(in srgb, var(--dsw-alias-label-primary) 14%, transparent), 0 36px 78px color-mix(in srgb, var(--dsw-alias-label-primary) 18%, transparent)}@keyframes _7N6W4G_agentTeamsPanelIn{0%{opacity:0}to{opacity:1}}@keyframes _7N6W4G_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}._7N6W4G_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);cursor:grab;touch-action:none;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px 0 16px;display:flex}._7N6W4G_panelHead:active,._7N6W4G_panel[data-dragging] ._7N6W4G_panelHead{cursor:grabbing}._7N6W4G_panel[data-compact] ._7N6W4G_panelHead{cursor:default;touch-action:auto}._7N6W4G_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}._7N6W4G_panelControls{flex:none;align-items:center;gap:2px;display:inline-flex}._7N6W4G_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}._7N6W4G_iconButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}._7N6W4G_iconButton:active{transform:scale(.94)}._7N6W4G_iconButton[data-control=dock][data-mode=docked] svg{transform:scaleX(-1)}._7N6W4G_resizeHandle{z-index:1;touch-action:none;position:absolute}._7N6W4G_resizeHandle[data-resize-edge=left]{cursor:ew-resize;width:8px;top:44px;bottom:8px;left:0}._7N6W4G_resizeHandle[data-resize-edge=bottom]{cursor:ns-resize;height:8px;bottom:0;left:12px;right:12px}._7N6W4G_resizeHandle[data-resize-edge=corner]{cursor:nwse-resize;width:18px;height:18px;bottom:0;right:0}._7N6W4G_resizeHandle[data-resize-edge=corner]:after{border-right:1px solid var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-label-tertiary);content:\"\";opacity:.52;width:7px;height:7px;position:absolute;bottom:4px;right:4px}._7N6W4G_teams{overscroll-behavior:contain;scrollbar-color:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent) transparent;scrollbar-width:thin;flex-direction:column;min-height:0;display:flex;overflow-y:auto}._7N6W4G_teams::-webkit-scrollbar{width:6px}._7N6W4G_teams::-webkit-scrollbar-track{background:0 0}._7N6W4G_teams::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 28%, transparent);background-clip:padding-box;border:2px solid #0000;border-radius:999px}._7N6W4G_teams:hover::-webkit-scrollbar-thumb{background:color-mix(in srgb, var(--dsw-alias-label-tertiary) 44%, transparent);background-clip:padding-box}._7N6W4G_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 16px;display:flex}._7N6W4G_team:last-child{border-bottom:0}._7N6W4G_teamHead{align-items:center;gap:10px;min-width:0;display:flex}._7N6W4G_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}._7N6W4G_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10.5px;line-height:16px;display:inline-flex}._7N6W4G_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}._7N6W4G_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}._7N6W4G_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}._7N6W4G_delegationSection{min-width:0}._7N6W4G_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:56px;padding:6px 10px;display:grid}._7N6W4G_captainAvatar,._7N6W4G_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}._7N6W4G_captainAvatar{width:46px;height:46px}._7N6W4G_leadAvatar,._7N6W4G_memberArt{object-fit:contain;filter:drop-shadow(0 1px 1px #122d4833);background:0 0;border:0;border-radius:0}._7N6W4G_leadAvatar{width:44px;height:44px}._7N6W4G_memberArt{width:40px;height:40px}._7N6W4G_captainInfo,._7N6W4G_memberInfo{flex-direction:column;min-width:0;display:flex}._7N6W4G_captainInfo{gap:2px}._7N6W4G_captainLine,._7N6W4G_memberLine{align-items:center;gap:6px;min-width:0;display:flex}._7N6W4G_captainName,._7N6W4G_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}._7N6W4G_captainRole,._7N6W4G_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}._7N6W4G_captainSummary,._7N6W4G_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;line-height:15px;overflow:hidden}._7N6W4G_captainState,._7N6W4G_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}._7N6W4G_captainState[data-busy=true],._7N6W4G_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}._7N6W4G_workGlyph rect{opacity:.5}._7N6W4G_workGlyph[data-active=true] rect{animation:1.1s ease-in-out infinite _7N6W4G_agentTeamsDot}@keyframes _7N6W4G_agentTeamsDot{0%,to{opacity:.25}50%{opacity:1}}._7N6W4G_progressOverview{flex-direction:column;gap:7px;display:flex}._7N6W4G_progressTitle{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:16px}._7N6W4G_progressSegments{gap:3px;display:flex}._7N6W4G_progressSegments>span,._7N6W4G_progressEmpty{background:var(--dsw-alias-line-strong);border-radius:2px;flex:1;height:5px}._7N6W4G_progressEmpty{width:100%;display:block}._7N6W4G_progressSegments>span[data-state=running]{background:var(--dsw-alias-state-business-primary)}._7N6W4G_progressSegments>span[data-state=blocked]{background:var(--dsw-alias-state-warning)}._7N6W4G_progressSegments>span[data-state=completed]{background:var(--dsw-alias-state-success)}._7N6W4G_progressSegments>span[data-state=failed]{background:var(--dsw-alias-state-danger)}._7N6W4G_progressSegments>span[data-state=cancelled]{opacity:.55}._7N6W4G_progressLegend{color:var(--dsw-alias-label-tertiary);gap:10px;font-size:9.5px;line-height:14px;display:flex}._7N6W4G_progressLegend>span[data-state=running]{color:var(--dsw-alias-state-business-primary)}._7N6W4G_progressLegend>span[data-state=blocked]{color:var(--dsw-alias-state-warning)}._7N6W4G_progressLegend>span[data-state=completed]{color:var(--dsw-alias-state-success)}._7N6W4G_progressSummary{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));min-width:0;color:var(--dsw-alias-label-secondary);border-radius:8px;align-items:center;gap:6px;padding:5px 8px;font-size:10px;font-weight:600;line-height:15px;display:flex}._7N6W4G_progressSummary[data-state=warning]{background:color-mix(in srgb, var(--dsw-alias-state-warning) 8%, var(--dsw-alias-bg-module))}._7N6W4G_progressSummary[data-state=completed]{background:color-mix(in srgb, var(--dsw-alias-state-success) 8%, var(--dsw-alias-bg-module))}._7N6W4G_progressSummary>span:last-child{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._7N6W4G_progressSummaryDot{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:5px;height:5px}._7N6W4G_progressSummary[data-state=warning] ._7N6W4G_progressSummaryDot{background:var(--dsw-alias-state-warning)}._7N6W4G_progressSummary[data-state=completed] ._7N6W4G_progressSummaryDot{background:var(--dsw-alias-state-success)}._7N6W4G_membersToggle{background:var(--dsw-alias-bg-module-platform);width:100%;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:0;border-radius:8px;justify-content:space-between;align-items:center;gap:8px;padding:6px 8px;font-size:10.5px;font-weight:600;line-height:15px;display:flex}._7N6W4G_membersToggle:hover{background:var(--dsw-alias-bg-fill-neutral)}._7N6W4G_membersToggle>span{align-items:center;gap:5px;display:inline-flex}._7N6W4G_membersToggle>span:last-child{color:var(--dsw-alias-state-business-primary)}._7N6W4G_chevron{flex:none;transition:transform .14s}._7N6W4G_chevron[data-open=true]{transform:rotate(90deg)}._7N6W4G_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:9px 0 0 20px;display:flex;position:relative}._7N6W4G_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}._7N6W4G_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}._7N6W4G_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:27px;right:100%}._7N6W4G_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}._7N6W4G_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:48px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:46px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}._7N6W4G_memberRow:hover,._7N6W4G_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}._7N6W4G_memberRow:active{transform:scale(.995)}._7N6W4G_memberAvatar{width:42px;height:42px}._7N6W4G_memberAvatar[data-unread=true]:after{box-sizing:border-box;border:1px solid var(--dsw-alias-bg-module);background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:6px;height:6px;animation:1.8s ease-in-out infinite _7N6W4G_agentTeamsUnreadPulse;position:absolute;top:0;right:-1px}@keyframes _7N6W4G_agentTeamsUnreadPulse{0%,to{opacity:.78;transform:scale(.92)}50%{opacity:1;transform:scale(1.16)}}._7N6W4G_memberInitial{background:var(--dsw-alias-bg-fill-business);width:34px;height:34px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}._7N6W4G_stateArt{box-sizing:border-box;object-fit:contain;width:22px;height:22px;filter:drop-shadow(0 0 1px var(--dsw-alias-bg-module)) drop-shadow(0 1px 1px #122d483d);background:0 0;border:0;border-radius:0;position:absolute;bottom:-3px;right:-5px}._7N6W4G_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite _7N6W4G_agentTeamsFloat}._7N6W4G_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite _7N6W4G_agentTeamsBreathe}._7N6W4G_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite _7N6W4G_agentTeamsThink}@keyframes _7N6W4G_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes _7N6W4G_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes _7N6W4G_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}._7N6W4G_memberState{margin-left:auto}._7N6W4G_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10.5px;line-height:16px}._7N6W4G_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 60px;display:flex}._7N6W4G_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9.5px;line-height:14px}._7N6W4G_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}._7N6W4G_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}._7N6W4G_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}._7N6W4G_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}._7N6W4G_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}._7N6W4G_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}._7N6W4G_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}._7N6W4G_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9.5px;font-weight:600;line-height:14px}._7N6W4G_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9.5px;line-height:14px}._7N6W4G_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}._7N6W4G_sectionToggleTitle{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}._7N6W4G_dagViewport{scrollbar-width:thin;min-width:0;padding:2px 0 4px;overflow-x:auto}._7N6W4G_dagCanvas{min-width:100%;position:relative}._7N6W4G_dagCanvas[data-layout=parallel]{flex-wrap:wrap;gap:8px;display:flex}._7N6W4G_dagCanvas[data-layout=parallel] ._7N6W4G_dagNode{flex:92px;min-width:92px;position:relative}._7N6W4G_dagEdges{pointer-events:none;position:absolute;inset:0;overflow:visible}._7N6W4G_dagEdges path{fill:none;stroke:var(--dsw-alias-line-strong);stroke-width:1px;transition:opacity .14s,stroke .14s,stroke-width .14s}._7N6W4G_dagEdges path[data-active=true]{stroke:var(--dsw-alias-state-business-primary);stroke-width:1.6px}._7N6W4G_dagEdges path[data-dimmed=true]{opacity:.24}._7N6W4G_dagNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:6px;flex-direction:column;justify-content:center;gap:1px;padding:0 6px;transition:border-color .14s,background-color .14s,opacity .14s;display:flex;position:absolute}._7N6W4G_dagNode:hover,._7N6W4G_dagNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}._7N6W4G_dagNode[data-dimmed=true]{opacity:.3}._7N6W4G_dagNode[data-state=running][data-dimmed=true]{opacity:.58}._7N6W4G_dagNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}._7N6W4G_dagNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}._7N6W4G_dagNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}._7N6W4G_dagNodeHead{color:var(--dsw-alias-label-primary);align-items:center;gap:4px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9.5px;font-weight:700;display:flex}._7N6W4G_dagNodeDot{background:var(--dsw-alias-line-strong);border-radius:1.5px;flex:none;width:5px;height:5px}._7N6W4G_dagNode[data-state=running] ._7N6W4G_dagNodeDot{background:var(--dsw-alias-state-business-primary)}._7N6W4G_dagNode[data-state=running] ._7N6W4G_dagNodeHead{padding-right:12px}._7N6W4G_dagRunningState{width:9px;height:9px;color:var(--dsw-alias-state-business-primary);pointer-events:none;justify-content:center;align-items:center;display:inline-flex;position:absolute;top:4px;right:5px}._7N6W4G_dagRunningState ._7N6W4G_workGlyph{width:9px;height:9px}._7N6W4G_dagNode[data-state=blocked] ._7N6W4G_dagNodeDot{background:var(--dsw-alias-state-warning)}._7N6W4G_dagNode[data-state=completed] ._7N6W4G_dagNodeDot{background:var(--dsw-alias-state-success)}._7N6W4G_dagNode[data-state=failed] ._7N6W4G_dagNodeDot{background:var(--dsw-alias-state-danger)}._7N6W4G_dagNodeLabel{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:8.5px;line-height:11px;overflow:hidden}._7N6W4G_taskDetail{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:9px;flex-direction:column;gap:3px;min-width:0;padding:7px 9px;display:flex}._7N6W4G_taskDetailHead{align-items:center;gap:6px;min-width:0;display:flex}._7N6W4G_taskDetailId{color:var(--dsw-alias-state-business-primary);flex:none;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;font-weight:700}._7N6W4G_taskDetailSubject{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:600;line-height:16px;overflow:hidden}._7N6W4G_taskDetailBadge{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;padding:0 5px;font-size:8.5px;font-weight:600;line-height:14px}._7N6W4G_taskDetailBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}._7N6W4G_taskDetailBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}._7N6W4G_taskDetailBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}._7N6W4G_taskDetailBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}._7N6W4G_taskDetailLine,._7N6W4G_taskDetailMeta{color:var(--dsw-alias-label-secondary);font-size:9.5px;line-height:14px}._7N6W4G_taskDetailMeta{color:var(--dsw-alias-label-tertiary)}._7N6W4G_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:11px;line-height:16px}._7N6W4G_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9.5px;font-weight:600;line-height:15px}._7N6W4G_members{flex-direction:column;gap:3px;display:flex}._7N6W4G_archivedWrap:before{color:var(--dsw-alias-label-tertiary);content:\"已结束 · 历史归档\";padding:5px 14px 0;font-size:9.5px;font-weight:600;line-height:14px;display:block}@media (prefers-reduced-motion:reduce){._7N6W4G_panel,._7N6W4G_badge,._7N6W4G_badgeDot,._7N6W4G_panelDot,._7N6W4G_workGlyph rect,._7N6W4G_stateArt,._7N6W4G_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html[data-agent-teams-panel-open] [data-phase=active]{padding-right:0}}@media (width<=640px){._7N6W4G_badge{top:56px;right:10px}._7N6W4G_teamStats span[data-stat=messages]{display:none}._7N6W4G_captainNode{grid-template-columns:48px minmax(0,1fr)}._7N6W4G_captainState{display:none}._7N6W4G_delegationTree{margin-left:12px;padding-left:15px}._7N6W4G_memberBranch{width:15px}._7N6W4G_assignmentLine{padding-left:53px}}";
		const tagId = "dsh-agent-teams-nanmicoder-by-andrew/ActivityPanel.module.css";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "_7N6W4G_agentTeamsBreathe",
			"agentTeamsDot": "_7N6W4G_agentTeamsDot",
			"agentTeamsFloat": "_7N6W4G_agentTeamsFloat",
			"agentTeamsPanelIn": "_7N6W4G_agentTeamsPanelIn",
			"agentTeamsPulse": "_7N6W4G_agentTeamsPulse",
			"agentTeamsThink": "_7N6W4G_agentTeamsThink",
			"agentTeamsUnreadPulse": "_7N6W4G_agentTeamsUnreadPulse",
			"archivedWrap": "_7N6W4G_archivedWrap",
			"assignmentChip": "_7N6W4G_assignmentChip",
			"assignmentLabel": "_7N6W4G_assignmentLabel",
			"assignmentLine": "_7N6W4G_assignmentLine",
			"assignmentTasks": "_7N6W4G_assignmentTasks",
			"badge": "_7N6W4G_badge",
			"badgeCount": "_7N6W4G_badgeCount",
			"badgeDot": "_7N6W4G_badgeDot",
			"captainAvatar": "_7N6W4G_captainAvatar",
			"captainInfo": "_7N6W4G_captainInfo",
			"captainLine": "_7N6W4G_captainLine",
			"captainName": "_7N6W4G_captainName",
			"captainNode": "_7N6W4G_captainNode",
			"captainRole": "_7N6W4G_captainRole",
			"captainState": "_7N6W4G_captainState",
			"captainSummary": "_7N6W4G_captainSummary",
			"chevron": "_7N6W4G_chevron",
			"dagCanvas": "_7N6W4G_dagCanvas",
			"dagEdges": "_7N6W4G_dagEdges",
			"dagNode": "_7N6W4G_dagNode",
			"dagNodeDot": "_7N6W4G_dagNodeDot",
			"dagNodeHead": "_7N6W4G_dagNodeHead",
			"dagNodeLabel": "_7N6W4G_dagNodeLabel",
			"dagRunningState": "_7N6W4G_dagRunningState",
			"dagViewport": "_7N6W4G_dagViewport",
			"delegationSection": "_7N6W4G_delegationSection",
			"delegationTree": "_7N6W4G_delegationTree",
			"dependencySection": "_7N6W4G_dependencySection",
			"emptyHint": "_7N6W4G_emptyHint",
			"historicPill": "_7N6W4G_historicPill",
			"iconButton": "_7N6W4G_iconButton",
			"leadAvatar": "_7N6W4G_leadAvatar",
			"memberArt": "_7N6W4G_memberArt",
			"memberAvatar": "_7N6W4G_memberAvatar",
			"memberBlock": "_7N6W4G_memberBlock",
			"memberBranch": "_7N6W4G_memberBranch",
			"memberCount": "_7N6W4G_memberCount",
			"memberInfo": "_7N6W4G_memberInfo",
			"memberInitial": "_7N6W4G_memberInitial",
			"memberLine": "_7N6W4G_memberLine",
			"memberName": "_7N6W4G_memberName",
			"memberRole": "_7N6W4G_memberRole",
			"memberRow": "_7N6W4G_memberRow",
			"memberState": "_7N6W4G_memberState",
			"memberStatusLine": "_7N6W4G_memberStatusLine",
			"members": "_7N6W4G_members",
			"membersToggle": "_7N6W4G_membersToggle",
			"panel": "_7N6W4G_panel",
			"panelControls": "_7N6W4G_panelControls",
			"panelDot": "_7N6W4G_panelDot",
			"panelHead": "_7N6W4G_panelHead",
			"panelTitle": "_7N6W4G_panelTitle",
			"progressEmpty": "_7N6W4G_progressEmpty",
			"progressLegend": "_7N6W4G_progressLegend",
			"progressOverview": "_7N6W4G_progressOverview",
			"progressSegments": "_7N6W4G_progressSegments",
			"progressSummary": "_7N6W4G_progressSummary",
			"progressSummaryDot": "_7N6W4G_progressSummaryDot",
			"progressTitle": "_7N6W4G_progressTitle",
			"resizeHandle": "_7N6W4G_resizeHandle",
			"sectionHead": "_7N6W4G_sectionHead",
			"sectionHint": "_7N6W4G_sectionHint",
			"sectionTitle": "_7N6W4G_sectionTitle",
			"sectionToggleTitle": "_7N6W4G_sectionToggleTitle",
			"stageLabel": "_7N6W4G_stageLabel",
			"stateArt": "_7N6W4G_stateArt",
			"taskDetail": "_7N6W4G_taskDetail",
			"taskDetailBadge": "_7N6W4G_taskDetailBadge",
			"taskDetailHead": "_7N6W4G_taskDetailHead",
			"taskDetailId": "_7N6W4G_taskDetailId",
			"taskDetailLine": "_7N6W4G_taskDetailLine",
			"taskDetailMeta": "_7N6W4G_taskDetailMeta",
			"taskDetailSubject": "_7N6W4G_taskDetailSubject",
			"taskEmpty": "_7N6W4G_taskEmpty",
			"taskId": "_7N6W4G_taskId",
			"team": "_7N6W4G_team",
			"teamHead": "_7N6W4G_teamHead",
			"teamName": "_7N6W4G_teamName",
			"teamStats": "_7N6W4G_teamStats",
			"teams": "_7N6W4G_teams",
			"unreadPill": "_7N6W4G_unreadPill",
			"workGlyph": "_7N6W4G_workGlyph"
		};
		//#endregion
