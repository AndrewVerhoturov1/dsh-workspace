/**
 * Nanmicoder by Andrew — AgentTeams for DeepSeek Harness.
 *
 ...
 * results.
 *
 * Installation (bundle): `dsh plugin --profile <name> add dsh-agent-teams-nanmicoder-by-andrew`
...
export declare const name = "dsh-agent-teams-nanmicoder-by-andrew";
