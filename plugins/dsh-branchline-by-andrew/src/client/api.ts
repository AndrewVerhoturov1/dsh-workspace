...
export interface StudioClientActions {
  ...
  startTaskRuntime(task: TaskView): Promise<BranchRuntimeView>
  runtimeStatus(worktreePath: string): Promise<BranchRuntimeView | null>
  stopRuntime(runtimeId: string): Promise<BranchRuntimeView>
  cleanupRuntime(runtimeId: string): Promise<void>
