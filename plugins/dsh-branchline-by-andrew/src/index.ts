...
import { BranchRuntimeService } from './runtime/runtime-service.ts'
...
export async function apply(ctx: Context, config: Config): Promise<void> {
  ...
  const runtime = new BranchRuntimeService(dshHome)
  ...
  ctx.inject(['webServer'], webCtx => webCtx.effect(
    () => registerWorktreeStudioWeb(webCtx, github, runtime),
    'dsh-branchline.web',
  ))
