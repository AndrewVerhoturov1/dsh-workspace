...
This archive supersedes the original `WEB_POSTMAN_WP_006.zip` whose `changes.patch` was generated with incorrect file positioning.

This Repair 01 is still based on exact `d837b85996ebe82cda40c72bfe03b629b2f5ed71`. The implementation code is unchanged; only the patch packaging was corrected.

Do not use the old WP-006 archive.

# WP-006 REPAIR 01 / P5 — Artifact DOM Detection
