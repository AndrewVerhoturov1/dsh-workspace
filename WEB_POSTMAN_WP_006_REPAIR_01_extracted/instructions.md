...
Only `changes.patch` packaging was corrected. `artifact_detector.py` and its 32-test implementation are unchanged from the original WP-006 package.
The patch is regenerated for exact base `d837b85996ebe82cda40c72bfe03b629b2f5ed71` using real file context/line positions.
